...
public class FooterServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        // DISPLAY GLOBAL STATE (Visitor Counter)
        out.println("       <div style='background: #f8fafc; padding: 0.8rem; border-radius: 12px; display: inline-block; margin: 0 auto;'>");
        out.println("           <span style='font-weight: 700; color: #0284c7;'>Global Site Visitors:</span> " + count);
        out.println("       </div>");
