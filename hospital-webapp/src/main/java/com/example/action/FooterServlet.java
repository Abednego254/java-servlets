...
public class FooterServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        out.println("           <a href='./home' style='color: #64748b; text-decoration: none;'>Home</a>");
        out.println("           <a href='./services' style='color: #64748b; text-decoration: none;'>Services</a>");
        out.println("           <a href='./appointment' style='color: #0284c7; font-weight: 700; text-decoration: none;'>Bookings</a>");
        out.println("       </div>");
        out.println("    </div>");
        out.println("  </footer>");
        out.println("</body>");
